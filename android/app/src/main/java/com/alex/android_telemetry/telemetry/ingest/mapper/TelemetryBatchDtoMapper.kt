    ...
    private fun mapTripConfig(config: EventThresholdSet): TripConfigDto {
        return TripConfigDto(
            v2 = V2ConfigDto(
                ...
                accelInTurnSharpG = config.accelSharpG,
                accelInTurnEmergencyG = config.accelEmergencyG,
                brakeInTurnSharpG = config.brakeSharpG,
                brakeInTurnEmergencyG = config.brakeEmergencyG,
                roadWindowS = 0.40,
                roadLowP2PG = 0.70,
                roadHighP2PG = 1.10,
